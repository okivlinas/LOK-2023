...
void your_$(int n_your_$)
{
	if (n_your_$ == 1021)
	{
		std::cout << "Вы верно представили число " << n_your_$ << " в шестнадцатиричном формате!\n"; 
		
	}
	else	
	{
		std::cout << "Вы неверно представили число " << n_your_$ << " в шестнадцатиричном формате!\n"; 
...
int main()
{
	...
	std::cout << "Факториал " << n_$l4_main_$ << " равен: " << res_$l4_main_$ << '\n'; 
	...
	char c_$l4_main_$ = 'c'; 
	std::cout << "Переменная типа СИМВОЛ инициализорованная явно: " << c_$l4_main_$ << '\n'; 
	char s_$l4_main_$ = 'f'; 
	std::cout << "Переменная типа СИМВОЛ инициализорованная неявно: " << s_$l4_main_$ << '\n'; 
	...
	std::cout << "Результат округления f1: " << round_$l4_main_$((float)f1_$l4_main_$); 
	return (int)(0); 
